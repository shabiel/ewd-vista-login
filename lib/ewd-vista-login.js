...
module.exports.handlers.cvc = function(messageObj, session, send, finished) {
  ...
  var package_properties = require(appdir + '/package.json');
  var package_config = package_properties.ewdVista.config; //This is an array
  if (package_config.includes('upper-case-vc')) {
